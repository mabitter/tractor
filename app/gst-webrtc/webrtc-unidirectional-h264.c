// taken from https://gitlab.freedesktop.org/gstreamer/gst-examples/-/blob/master/webrtc/sendonly/webrtc-unidirectional-h264.c
#include <locale.h>
#include <glib.h>
#include <gst/gst.h>
...
create_receiver_entry (SoupWebsocketConnection * connection)
{
  ...
  receiver_entry->pipeline =
      ...
      STUN_SERVER " "
      "udpsrc multicast-group=239.20.20.20 port=5000 !"
